...
class ExpenseForm extends React.Component {
  ...
  render() {
    return (<div className="expense-form-container">
      <label>
        <input className="expense-form" type="text" placeholder=" Your Name" value={this.state.user}
               onChange={this.handleChangeUser} />
      </label><br />
      <label>
        <input className="expense-form" type="number" placeholder=" Amount Spent" value={this.state.amount}
               onChange={this.handleChangeAmount} />
      </label><br />
      <label>
        <input className="expense-form" type="text" placeholder=" Activity Enjoyed" value={this.state.description}
